package com.ftc.notrepeat.rabbitmq.callback;
...
public class ReturnsCallback implements RabbitTemplate.ReturnsCallback {
    ...
    public void returnedMessage(ReturnedMessage returnedMessage) {
        ...
        //2.日志打印
        StaticLog.error("Message to queue fail. MessageId is [{}],replyCode is [{}],replyText is [{}]", message.getMessageProperties().getHeader(RabbitMqUtil.MESSAGE_ID_HEADER), replyCode, replyText);
